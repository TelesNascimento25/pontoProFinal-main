                ...
                <div class="card">
                    <div class="card-body p-5">
                      ...
                      <img src="${pageContext.request.contextPath}/resources/images/logo.jpg" alt="Logo pontoPro" class="mb-4" style="width: 100px; height: 100px; display: block; margin: auto;">
                       ...
                       <div class="alert alert-success text-center mt-2 <% if (request.getSession().getAttribute("mensagemSucesso") == null) { %>d-none<% } %> alert-space" role="alert">
						    <%= request.getSession().getAttribute("mensagemSucesso") %>
						</div>
                        ...
                        <form id="loginForm" method="post" action="<%= request.getContextPath() %>/login">
                         ...
                         <div class="d-grid gap-2">
						    ...
						    <a href="<%= request.getContextPath() %>/register" class="btn btn-secondary">Registrar</a>
						</div>
                        </form>
                    </div>
                </div>
